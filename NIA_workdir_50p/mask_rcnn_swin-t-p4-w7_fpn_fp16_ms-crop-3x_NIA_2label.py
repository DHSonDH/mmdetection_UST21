...
site = '50p'
data_root = 'data/ripcurrent_50p'
test_root = ''
test_show_gt = True
test_return_img_when_rip = True
img_norm_cfg = dict(
...
data = dict(
    ...
    train=dict(
        type='NIADataset',
        ann_file='data/ripcurrent_50p/train/annotation',
        img_prefix='data/ripcurrent_50p/train/img/',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(type='LoadAnnotations', with_bbox=True, with_mask=True),
            dict(type='RandomFlip', flip_ratio=0.5),
    ...
    val=dict(
        type='NIADataset',
        ann_file='data/ripcurrent_50p/val/annotation',
        img_prefix='data/ripcurrent_50p/val/img/',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(type='LoadAnnotations', with_bbox=True, with_mask=True),
            dict(
    ...
    test=dict(
        type='NIADataset',
        ann_file='data/ripcurrent_50p/test/annotation',
        img_prefix='data/ripcurrent_50p/test/img/',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
                type='MultiScaleFlipAug',
