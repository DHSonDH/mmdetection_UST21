...
data_root = 'data/ripcurrent_10p/ripcurrent_autolabel/PARA2'
img_norm_cfg = dict(
...
data = dict(
    ...
    train=dict(
        type='NIADataset',
        ann_file='data/ripcurrent_10p/train/annotation',
        img_prefix='data/ripcurrent_10p/train/img/',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(type='LoadAnnotations', with_bbox=True, with_mask=True),
            dict(type='RandomFlip', flip_ratio=0.5),
    ...
    val=dict(
        type='NIADataset',
        ann_file='data/ripcurrent_10p/val/annotation',
        img_prefix='data/ripcurrent_10p/val/img/',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(type='LoadAnnotations', with_bbox=True, with_mask=True),
            dict(
    ...
    test=dict(
        type='NIADataset',
        ann_file='data/ripcurrent_10p/test/annotation',
        img_prefix='data/ripcurrent_10p/test/img/',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
                type='MultiScaleFlipAug',
