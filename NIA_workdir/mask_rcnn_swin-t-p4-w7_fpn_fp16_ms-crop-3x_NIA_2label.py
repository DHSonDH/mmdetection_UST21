...
site = 'PARA2'
data_root = f'data/ripcurrent_autolabel/train/{site}'
test_root = f''
test_show_gt = True
...
data = dict(
    ...
    train=dict(
        type='NIADataset',
        ann_file=f'{data_root}/train/annotation',
        img_prefix=f'{data_root}/train/img/',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(type='LoadAnnotations', with_bbox=True, with_mask=True),
            dict(type='RandomFlip', flip_ratio=0.5),
    ...
    val=dict(
        type='NIADataset',
        ann_file=f'{data_root}/val/annotation',
        img_prefix=f'{data_root}/val/img/',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(type='LoadAnnotations', with_bbox=True, with_mask=True),
            dict(
    ...
    test=dict(
        type='NIADataset',
        ann_file=f'{test_root}/annotation',
        img_prefix=f'{test_root}/img/',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
                type='MultiScaleFlipAug',
